...
@input-validatie
Functionaliteit: input validatie bij raadplegen bewoning met periode

  Regel: De adresseerbaarObjectIdentificatie, datumVan en datumTot parameters zijn verplichte parameters
...
Regel: datumVan en datumTot zijn een datum string geformatteerd volgens de [ISO 8601 date format](https://www.w3.org/QA/Tips/iso-date)
...
Regel: datumTot ligt na datumVan
