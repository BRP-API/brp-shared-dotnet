...
Functionaliteit: autorisatie gegevens van Europees kiesrecht van Persoon
  ...
  Abstract Scenario: Afnemer vraagt om veld <fields> waarvoor deze niet geautoriseerd is
    ...
    Dan heeft de response de volgende gegevens
      ...
      | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                             |
      | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                                 |
      | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: europeesKiesrecht.aanduiding |
      | status   |                                                                                                     403 |
      | code     | unauthorizedField                                                                                       |
      | instance | /haalcentraal/api/brp/personen                                                                          |
  ...
  Abstract Scenario: Afnemer vraagt om veld <fields> waarvoor deze niet geautoriseerd is
    ...
    Dan heeft de response de volgende gegevens
      ...
      | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                                       |
      | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                                           |
      | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: europeesKiesrecht.einddatumUitsluiting |
      | status   |                                                                                                               403 |
      | code     | unauthorizedField                                                                                                 |
      | instance | /haalcentraal/api/brp/personen                                                                                    |
