  ...
  Regel: Wanneer met fields gevraagd wordt om een veld waarvoor de gebruiker niet geautoriseerd is, wordt een foutmelding gegeven
    ...
    Abstract Scenario: Afnemer vraagt <gevraagd veld> (<missende autorisatie>), waarvoor deze niet geautoriseerd is
      ...
      Dan heeft de response de volgende gegevens
        ...
        | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                |
        | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                    |
        | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: <missende veld> |
        | status   |                                                                                        403 |
        | code     | unauthorizedField                                                                          |
        | instance | /haalcentraal/api/brp/personen                                                             |
      ...
      Voorbeelden:
        ...
        | nationaliteiten.nationaliteit.code                | 46310 46510 48510 |                40510 | nationaliteiten.nationaliteit         |
        | nationaliteiten.nationaliteit.omschrijving        | 4631 465100 48510 |                40510 | nationaliteiten.nationaliteit         |
        | nationaliteiten.redenOpname.code                  | 40510 46510 48510 |                46310 | nationaliteiten.redenOpname           |
        | nationaliteiten.redenOpname.omschrijving          | 40510 46510 48510 |                46310 | nationaliteiten.redenOpname           |
        | nationaliteiten.datumIngangGeldigheid.langFormaat | 40510 46310 46510 |                48510 | nationaliteiten.datumIngangGeldigheid |
        | nationaliteiten.datumIngangGeldigheid.type        | 40510 46310 46510 |                48510 | nationaliteiten.datumIngangGeldigheid |
        | nationaliteiten.datumIngangGeldigheid.datum       | 40510 46310 46510 |                48510 | nationaliteiten.datumIngangGeldigheid |
        | nationaliteiten.datumIngangGeldigheid.onbekend    | 40510 46310 46510 |                48510 | nationaliteiten.datumIngangGeldigheid |
        | nationaliteiten.datumIngangGeldigheid.jaar        | 40510 46310 46510 |                48510 | nationaliteiten.datumIngangGeldigheid |
        | nationaliteiten.datumIngangGeldigheid.maand       | 40510 46310 46510 |                48510 | nationaliteiten.datumIngangGeldigheid |
