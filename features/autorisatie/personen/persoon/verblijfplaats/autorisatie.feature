  ...
  Regel: Wanneer met fields gevraagd wordt om een veld waarvoor de gebruiker niet geautoriseerd is, wordt een foutmelding gegeven
    ...
    Abstract Scenario: Afnemer vraagt <gevraagd veld> (<missende autorisatie>), waarvoor deze niet geautoriseerd is
      ...
      Als personen wordt gezocht met de volgende parameters
        ...
        | type                | RaadpleegMetBurgerservicenummer                    |
        | burgerservicenummer |                                          000000024 |
        | fields              | burgerservicenummer,verblijfplaats.<missende veld> |
      Dan heeft de response de volgende gegevens
        | naam     | waarde                                                                                                    |
        | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                               |
        | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                                   |
        | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: verblijfplaats.<missende veld> |
        | status   |                                                                                                       403 |
        | code     | unauthorizedField                                                                                         |
        | instance | /haalcentraal/api/brp/personen                                                                            |

      Voorbeelden:
        | gevraagd veld                                      | ad hoc rubrieken                                                                                                               | missende autorisatie | missende veld                         |
        | verblijfadres.aanduidingBijHuisnummer.code         | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 88510 PAVP01 |                81150 | verblijfadres.aanduidingBijHuisnummer |
        | verblijfadres.aanduidingBijHuisnummer.omschrijving | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 88510 PAVP01 |                81150 | verblijfadres.aanduidingBijHuisnummer |
        | verblijfadres.land.code                            | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81320 81330 81340 81350 88510 PAVP01 |                81310 | verblijfadres.land                    |
        | verblijfadres.land.omschrijving                    | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81320 81330 81340 81350 88510 PAVP01 |                81310 | verblijfadres.land                    |
        | datumIngangGeldigheid.type                         | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.datum                        | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.langFormaat                  | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.jaar                         | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.maand                        | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.onbekend                     | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 81310 81320 81330 81340 81350 PAVP01 |                88510 | datumIngangGeldigheid                 |
  ...
  Regel: de 'verblijfplaatsBinnenland' field alias moet worden gebruikt door een consumer die niet is geautoriseerd voor het bevragen van 'verblijfplaats buitenland' velden
    ...
    Abstract Scenario: Afnemer vraagt verblijfplaatsBinnenland.<gevraagd veld> (<missende autorisatie>), waarvoor deze niet geautoriseerd is
      ...
      Als personen wordt gezocht met de volgende parameters
        ...
        | type                | RaadpleegMetBurgerservicenummer                              |
        | burgerservicenummer |                                                    000000024 |
        | fields              | burgerservicenummer,verblijfplaatsBinnenland.<missende veld> |
      Dan heeft de response de volgende gegevens
        | naam     | waarde                                                                                                              |
        | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                                         |
        | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                                             |
        | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: verblijfplaatsBinnenland.<missende veld> |
        | status   |                                                                                                                 403 |
        | code     | unauthorizedField                                                                                                   |
        | instance | /haalcentraal/api/brp/personen                                                                                      |
      ...
      Voorbeelden:
        | gevraagd veld                                      | ad hoc rubrieken                                                                                 | missende autorisatie | missende veld                         |
        | verblijfadres.aanduidingBijHuisnummer.code         | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81160 81170 81180 81190 81210 88510 PAVP01 |                81150 | verblijfadres.aanduidingBijHuisnummer |
        | verblijfadres.aanduidingBijHuisnummer.omschrijving | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81160 81170 81180 81190 81210 88510 PAVP01 |                81150 | verblijfadres.aanduidingBijHuisnummer |
        | datumIngangGeldigheid.type                         | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.datum                        | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.langFormaat                  | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.jaar                         | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.maand                        | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 PAVP01 |                88510 | datumIngangGeldigheid                 |
        | datumIngangGeldigheid.onbekend                     | 10120 80910 81010 81030 81110 81115 81120 81130 81140 81150 81160 81170 81180 81190 81210 PAVP01 |                88510 | datumIngangGeldigheid                 |
