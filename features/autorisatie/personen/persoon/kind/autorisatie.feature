...
Functionaliteit: autorisatie gegevens van kindgegevens van Persoon
  ...
  Abstract Scenario: Afnemer vraagt om veld <fields> waarvoor deze niet geautoriseerd is
    ...
    Dan heeft de response de volgende gegevens
      ...
      | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                        |
      | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                            |
      | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: kinderen.geboorte.datum |
      | status   |                                                                                                403 |
      | code     | unauthorizedField                                                                                  |
      | instance | /haalcentraal/api/brp/personen                                                                     |
  ...
  Abstract Scenario: Afnemer vraagt om veld <fields> waarvoor deze niet geautoriseerd is
    ...
    Dan heeft de response de volgende gegevens
      ...
      | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                         |
      | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                             |
      | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: kinderen.geboorte.plaats |
      | status   |                                                                                                 403 |
      | code     | unauthorizedField                                                                                   |
      | instance | /haalcentraal/api/brp/personen                                                                      |
  ...
  Abstract Scenario: Afnemer vraagt om veld <fields> waarvoor deze niet geautoriseerd is
    ...
    Dan heeft de response de volgende gegevens
      ...
      | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                                      |
      | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                                          |
      | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: kinderen.naam.adellijkeTitelPredicaat |
      | status   |                                                                                                              403 |
      | code     | unauthorizedField                                                                                                |
      | instance | /haalcentraal/api/brp/personen                                                                                   |
  ...
  Abstract Scenario: Afnemer vraagt om veld <fields> waarvoor deze niet geautoriseerd is
    ...
    Dan heeft de response de volgende gegevens
      ...
      | type     | https://datatracker.ietf.org/doc/html/rfc7231#section-6.5.3                                       |
      | title    | U bent niet geautoriseerd voor één of meerdere opgegeven field waarden.                           |
      | detail   | U bent niet geautoriseerd om de volgende gegevens op te vragen met fields: kinderen.geboorte.land |
      | status   |                                                                                               403 |
      | code     | unauthorizedField                                                                                 |
      | instance | /haalcentraal/api/brp/personen                                                                    |
